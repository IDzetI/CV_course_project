...
class Menu(object):
    ...
    def get_image(self):
        ...
        for i in range(0, self.grid_size + 1):
            cv2.line(self.image, (i * self.resolution, 0), (i * self.resolution, self.image.shape[0]), (0, 0, 255),
                     line_size)
        for i in range(0, self.grid_size + 1):
            cv2.line(self.image, (0, i * self.resolution), (self.image.shape[1], i * self.resolution), (0, 0, 255),
                     line_size)
        # highlight
...
class FrameManager(object):
    ...
    def update_from_frame(self, current_frame):
        ...
        # print(self.ui.ui_overlay.shape)
...
if __name__ == "__main__":
    ...
    # read config
    # i = 11
    # img = cv2.aruco.drawMarker(cv2.aruco.getPredefinedDictionary(cv2.aruco.DICT_4X4_1000), i, 1000)
    # cv2.imwrite('artag_'+str(i)+'.jpg', img)
    # exit(0)
...
[[ 57. 358.]
 ...
 [295. 123.]
 [297. 356.]]
[[-4.97048934e-03  6.19122907e-01  5.70000000e+01]
 [-5.97436150e-01  1.79217342e-02  3.58000000e+02]
 [ 5.36557447e-07  6.43868937e-05  1.00000000e+00]]
...
[[258. 325.]
 ...
 [309. 278.]
 [310. 327.]]
[[ 1.23939151e-02  1.14487590e-01  2.58000000e+02]
 [-1.06693355e-01 -1.13630905e-02  3.25000000e+02]
 [ 4.80384307e-05 -5.00400320e-05  1.00000000e+00]]
 '''